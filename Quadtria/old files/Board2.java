...
public class Board2 {
	...
	public Vector<Integer> getpecasJogo(int jogador)
	{
		if(jogador==1)
			{
				/*for(int i=0;i<5;i++){
					System.out.println(pecasJog2.get(i));
					 new Scanner(System.in).nextLine();
				}*/
				return pecasJog1;
			}
		else return pecasJog2;
		/*int pieces[] =getPiecePosition(jogador);
	...
	public Board2(Board2 board) {
		...
		moveCount1 = board.moveCount1;
		moveCount2 = board.moveCount2;
	...
	public void copy(Board2 _board) {
		moveCount = _board.moveCount;
		moveCount1 = _board.moveCount1;
		moveCount2 = _board.moveCount2;
