...
public class Board {
	...
	public int[] numMax(int player) {
		...
		if (player == 1) {
			for (int i = 0; i < pecasJog1.size(); i++) {
				if (pecasJog1.get(i) == 0 | pecasJog1.get(i) == 2
						| pecasJog1.get(i) == 8 | pecasJog1.get(i) == 14
						| pecasJog1.get(i) == 16)
					first++;
				else if (pecasJog1.get(i) == 4 | pecasJog1.get(i) == 6
						| pecasJog1.get(i) == 12 | pecasJog1.get(i) == 18
						| pecasJog1.get(i) == 20) {
					sec++;
					if (sec > max)
						max = sec;
				} else if (pecasJog1.get(i) == 28 | pecasJog1.get(i) == 30
						| pecasJog1.get(i) == 36 | pecasJog1.get(i) == 42
						| pecasJog1.get(i) == 44) {
					third++;
					if (third > max)
						max = third;
	...
	public int numPiece1Quad(int player) {
		int num = 0;
		if (intBoard[0] == player)
			num++;
		if (intBoard[2] == player)
			num++;
		if (intBoard[8] == player)
			num++;
		if (intBoard[14] == player)
			num++;
		if (intBoard[16] == player)
			num++;
		return num;
	}
	...
	public int numPiece2Quad(int player) {
		int num = 0;
		if (intBoard[4] == player)
			num++;
		if (intBoard[6] == player)
			num++;
		if (intBoard[12] == player)
			num++;
		if (intBoard[18] == player)
			num++;
		if (intBoard[20] == player)
			num++;
		return num;
	}
	...
	public int numPiece3Quad(int player) {
		int num = 0;
		if (intBoard[28] == player)
			num++;
		if (intBoard[30] == player)
			num++;
		if (intBoard[36] == player)
			num++;
		if (intBoard[42] == player)
			num++;
		if (intBoard[44] == player)
			num++;
		return num;
	}
	...
	public int numPiece4Quad(int player) {
		int num = 0;
		if (intBoard[32] == player)
			num++;
		if (intBoard[34] == player)
			num++;
		if (intBoard[40] == player)
			num++;
		if (intBoard[46] == player)
			num++;
		if (intBoard[48] == player)
			num++;
		return num;
	}

	public int inQuad(int num) {
		if (num == 0 | num == 2 | num == 8 | num == 14 | num == 16)
			return 1;
		if (num == 4 | num == 6 | num == 12 | num == 18 | num == 20)
			return 2;
		if (num == 28 | num == 30 | num == 36 | num == 42 | num == 44)
			return 3;
		return 4;
	}
	...
	public boolean hipoMove(int[] initBoard, int prevNo, int newNo, int player) {
		if (prevNo < 0 || prevNo > (initBoard.length - 2) || newNo < 0
				|| newNo > (initBoard.length - 2) || intBoard[prevNo] == 9
				|| intBoard[newNo] == 9)
			return false;
		if (intMoveSymbol == 1) {
	...
	public int[] possMove(int[] initBoard, int prevNo, int newNo, int player) {
	...
	/*
	 * public Board(int[] _intBoard, int size) { for (int x = 0; x <= (size *
	 * size); x++) { intBoard[x] = _intBoard[x]; } connections = new
	 * Hashtable<Integer, Vector<Integer>>(); setHash(); initPecas(); }
	 */
	...
	public void Allplayed(int player) {
		if (player == 1) {
			if (intBoard[0] != 1 && intBoard[2] != 1 && intBoard[8] != 1
					&& intBoard[14] != 1 && intBoard[16] != 1)
			{
				validCorner1 = true;
			}

		} else {
			if (intBoard[32] != 2 && intBoard[34] != 2 && intBoard[40] != 2
					&& intBoard[46] != 2 && intBoard[48] != 2)
				validCorner2 = true;
		}
	}
								...
								// condition]
	{
		...
		// & intBoard[20] != 0) {
		// return intBoard[6];
		// } else if (intBoard[28] == intBoard[36] & intBoard[36] ==
		// intBoard[42]
		// & intBoard[42] != 0) {
		// return intBoard[28];
		// } else if (intBoard[30] == intBoard[36] & intBoard[36] ==
		// intBoard[44]
		// & intBoard[44] != 0) {
		// return intBoard[30];
		// } else if (intBoard[32] == intBoard[40] & intBoard[40] ==
		// intBoard[46]
		// & intBoard[46] != 0 & (validCorner2||intBoard[32]==1)){
		// return intBoard[32];
		// } else if (intBoard[34] == intBoard[40] & intBoard[40] ==
		// intBoard[48]
		...
		// & intBoard[6] != 0) {
		// return intBoard[4];
		// } else if (intBoard[18] == intBoard[12] & intBoard[12] ==
		// intBoard[20]
		// & intBoard[20] != 0) {
		// return intBoard[18];
		// } else if (intBoard[28] == intBoard[36] & intBoard[36] ==
		...
		// & intBoard[30] != 0) {
		// return intBoard[28];
		// } else if (intBoard[42] == intBoard[36] & intBoard[36] ==
		// intBoard[44]
		// & intBoard[44] != 0) {
		// return intBoard[42];
		// } else if (intBoard[32] == intBoard[40] & intBoard[40] ==
		...
		// return intBoard[32];
		// } else if (intBoard[46] == intBoard[40] & intBoard[40] ==
		// intBoard[48]
		...
		// & intBoard[20] != 0) {
		// return intBoard[6];
		// } else if (intBoard[28] == intBoard[44] & intBoard[44] ==
		// intBoard[42]
		// & intBoard[42] != 0) {
		// return intBoard[28];
		// } else if (intBoard[30] == intBoard[42] & intBoard[42] ==
		// intBoard[44]
		// & intBoard[44] != 0) {
		// return intBoard[30];
		// } else if (intBoard[32] == intBoard[48] & intBoard[48] ==
		// intBoard[46]
		// & intBoard[46] != 0& (validCorner2||intBoard[32]==1)){
		// return intBoard[32];
		// } else if (intBoard[34] == intBoard[46] & intBoard[46] ==
		// intBoard[48]
		// & intBoard[48] != 0& (validCorner2||intBoard[34]==1)){
		// return intBoard[34];
		...
		// & intBoard[20] != 0) {
		// return intBoard[6];
		// } else if (intBoard[28] == intBoard[30] & intBoard[30] ==
		// intBoard[42]
		// & intBoard[42] != 0) {
		// return intBoard[28];
		// } else if (intBoard[30] == intBoard[28] & intBoard[28] ==
		// intBoard[44]
		// & intBoard[44] != 0) {
		// return intBoard[30];
		// } else if (intBoard[32] == intBoard[46] & intBoard[46] ==
		// intBoard[34]
		// & intBoard[34] != 0& (validCorner2||intBoard[32]==1)){
		// return intBoard[32];
		// } else if (intBoard[34] == intBoard[32] & intBoard[32] ==
		// intBoard[48]
		// & intBoard[48] != 0& (validCorner2||intBoard[34]==1)){
		// return intBoard[34];
		// }
	...
	public Vector<Integer> getPossibilities(int playerNo,
			int pecaInicial) {

	
		Vector<Integer> possibilities = new Vector<Integer>();

		Vector<Integer> pecas = connectionsGet(pecaInicial);
		for (int ind = 0; ind < pecas.size(); ind++) {
			int pecaFinal = pecas.get(ind);
			if (hipoMove(intBoard, pecaInicial,
					pecaFinal, playerNo)) {//prnt != null) {
				//System.out.println(pecaFinal);
				possibilities.add(pecaFinal);
